...
from gym.envs.robotics import mobile_dual_ur5_husky_gym_env
...
class HuskyPickAndPlaceEnv(mobile_dual_ur5_husky_gym_env.MobileDualUR5HuskyGymEnv, utils.EzPickle):
